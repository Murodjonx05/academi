...
$string['primarycolor_desc'] = 'Select the main brand color for your site.';
...
$string['secondarycolor'] = 'Accent Color';
$string['secondarycolor_desc'] = 'Select the accent color for your site.';
$string['textcolor'] = 'Text Color';
$string['textcolor_desc'] = 'Main text color used across the site. Leave empty to use the default neutral grey.';
$string['textcolorinverse'] = 'Contrast Text Color';
$string['textcolorinverse_desc'] = 'Text color used on dark or accent backgrounds (e.g. buttons, nav). Leave empty to use white.';
$string['navbg'] = 'Navbar Background';
$string['navbg_desc'] = 'Background color for the main site navigation bar. If empty, the primary colour is used.';
$string['navtext'] = 'Navbar Text';
$string['navtext_desc'] = 'Text/icon color for items inside the navigation bar. If empty, white is used.';
$string['navlinkhoveractivecolor'] = 'Navigation Text Color (Hover & Active)';
$string['navlinkhoveractivecolor_desc'] = 'The text color for navigation links when they are hovered over or active.';
$string['accentcolor'] = 'Accent Color';
$string['accentcolor_desc'] = 'Color for highlights, CTAs, and interactive elements. If empty, uses secondary color.';
$string['surface_muted'] = 'Surface Muted';
$string['surface_muted_desc'] = 'Background color for secondary surfaces like cards. If empty, uses a light grey.';
$string['enable_glassmorphism'] = 'Enable Glassmorphism';
$string['enable_glassmorphism_desc'] = 'Enable glassmorphism effect for the header navigation bar. When enabled, the header will have a semi-transparent background with blur effect.';
$string['glassmorphism_blur'] = 'Glassmorphism Blur Intensity';
$string['glassmorphism_blur_desc'] = 'Set the blur intensity for the glassmorphism effect (in pixels). Default is 16px.';
